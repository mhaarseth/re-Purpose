...
export const NOROFF_AVATAR_ENDPOINT =
  NOROFF_BASE_API + "/profiles/" + `${profileName}` + "/media";
export const NOROFF_YOUR_LISTINGS_ENDPOINT =
  NOROFF_BASE_API + "/profiles/" + `${profileName}`;
export const NOROFF_YOUR_BIDS_ENDPOINT =
  NOROFF_BASE_API + "/profiles/" + `${profileName}` + "/bids";

const queryString = window.location.search;
const urlParams = new URLSearchParams(queryString);
const bidId = urlParams.get("id");
export const NOROFF_PLACE_BID_ENDPOINT =
  NOROFF_BASE_API + "/listings/" + `${bidId}` + "/bids";
