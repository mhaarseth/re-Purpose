  ...
  try {
    ...
    singleListingDescriptionAndBid.innerHTML += `
      ...
      <div class="col-6">
        ...
        const bidValueField = document.getElementById("bid-value-field")
        ...
        if (highestBid === undefined) {
          ...
          bidValueField.innerHTML += `
          <input type="number" min="1" max="9999" step="1" value="1" class="form-control" id="bid-value">
          `;
        } else {
          ...
          bidValueField.innerHTML += `
          <input type="number" min="1" max="9999" step="1" value="${highestBidAmount + 1}" class="form-control" id="bid-value">
          `;
        }
